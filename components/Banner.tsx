...
<Button 
 ...
 className='tnsa translate-y-0 hover:-translate-y-2 transition delay-100  bg-transparent rounded-full  px-8 py-6 hover:bg-transparent hover:opacity-90 text-[#fff] text-[18px] font-[700] tracking-[-0.029px] leading-[32.79px] '>Get Started</Button>
