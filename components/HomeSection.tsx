    ...
    <section className="w-full relative overflow-x-clip">
      ...
      >
        <Image
          ...
          width={20}
          height={20}
          className="absolute left-[394px] top-[59px]  md:block hidden"
        />
        <Image
          src={"/largestar.png"}
          alt="star"
          width={12}
          height={12}
          className="absolute left-[294px] top-[349px]  md:block hidden"
        />
        <Image
          src={"/largestar.png"}
          alt="star"
          width={18}
          height={18}
          className="absolute right-[420px] top-[175px]  md:block hidden"
        />
        ...
        <Image
          ...
          width={36}
          height={36}
          className="absolute right-[158px] top-[375px]  md:block hidden "
        />
      </motion.div>
      ...
      <main className="mx-auto max-w-[80rem] flex flex-col items-center justify-center">
        ...
        <h6 className="mt-[81.91px] text-[#323232] text-center md:text-[60px] text-[32px] font-[700] md:leading-normal leading-[1.3]">
          A design subscription <br className="md:block hidden" /> designed for
          you
        </h6>
        ...
        <Button
          ...
          className="btn  text-[#FFF] text-[17px] tracking-[0.375px] font-[700] leading-[88.235%] translate-y-0 hover:-translate-y-2 transition delay-100 "
